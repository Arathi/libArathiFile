...
/*--------------------------------------------------
 ...
 +--------------------------------------------------
 | By Arathi
 | Copyright 2013 Arathi Software Foundation
...
/*--------------------------------------------------
 | Arathi File System Function
 +------------------------------------------------*/
function ext_size($target) {
    $size_sum = 0;
        ...
        if (is_dir($target)) {
            ...
            while($file_name = readdir($handle)) {
                if ($file_name != "." && $file_name != "..")
                    $size_sum += ext_size($target."/".$file_name);
            }
            @closedir($handle);
        } 
        else $size_sum = filesize($target);
    }
    return $size_sum;
}

function ext_delete($target) {
    $success = true;
    if (file_exists($target)) {
        @chmod($target,0755);
        if (is_dir($target)) {
